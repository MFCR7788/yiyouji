...
<body>
  ...
  <div class="page">
    <div class="brand">
      <img class="brand-logo" src="${escapeAttr(logoUrl)}" alt="易有吉" onerror="this.style.display='none'" />
    ...
    <div class="client-bar">
      ...
      <div class="client-text">
        <span class="client-name">${escapeHtml(displayName)}</span> 请求访问你的易有吉账户
      </div>
    </div>
