...
export function BasicInfoSection({
    ...
    return (
        <div className="space-y-4 sm:space-y-5 md:space-y-6 animate-fade-in w-full max-w-full">
            {/* 日主特征卡片 */}
            <section className="bg-background rounded-xl border border-border overflow-hidden w-full max-w-full box-border">
                <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-5 w-full max-w-full">
                    <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                        <div className="p-2 rounded-lg bg-foreground/5 flex-shrink-0">
                            <User className="w-5 h-5 text-foreground/40" />
                        </div>
                        <h2 className="text-sm font-semibold uppercase tracking-widest text-foreground/50 break-words flex-1 min-w-0 max-w-full">
                            日主特征
                        </h2>
                    </div>
                </div>
                <div className="px-3 sm:px-4 md:px-6 pb-3 sm:pb-4 md:pb-6 w-full max-w-full">
                    <div className="flex flex-col md:flex-row items-start gap-3 sm:gap-4 md:gap-6 w-full max-w-full">
                        <div
                        ...
                        <div className="space-y-2 md:space-y-3 flex-1 min-w-0 w-full max-w-full">
                            <div className="font-semibold text-base sm:text-lg md:text-xl text-foreground break-words w-full max-w-full">
                                日主「{canonicalChart.基本信息.日主}」，五行属{dayMasterElement}
                            </div>
                            <p className="text-xs sm:text-sm md:text-base text-foreground/70 leading-relaxed break-words w-full max-w-full">
                                {dayMasterDescription}
                            </p>
                        </div>
                    </div>
            ...
            <div className="space-y-4 sm:space-y-5 md:space-y-6 w-full max-w-full">
                ...
                {!hasKnownBirthTime ? (
                    <section className="bg-background rounded-xl border border-border overflow-hidden w-full max-w-full box-border">
                        <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 w-full max-w-full">
                            <div className="flex flex-col sm:flex-row items-start gap-2 sm:gap-3">
                                ...
                                <div className="space-y-3 flex-1 min-w-0 w-full max-w-full">
                                    <div>
                                    ...
                                    <div className="flex flex-col sm:flex-wrap items-start gap-2 px-3 py-2 bg-[#dfab01]/5 border border-[#dfab01]/10 rounded-lg text-xs text-[#dfab01] font-medium w-full max-w-full">
                    ...
                    <section className="bg-blue-50/30 border border-blue-100 rounded-xl p-4 sm:p-6 md:p-8 text-center w-full max-w-full box-border overflow-hidden">
                        <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-4">
                            <Sparkles className="w-6 h-6 text-[#2eaadc]" />
                        </div>
                        <div className="space-y-2 w-full max-w-full">
                            <h3 className="text-base font-bold break-words">AI 五行分析</h3>
                            <p className="text-sm text-foreground/50 break-words w-full max-w-full">
                ...
                {!hasKnownBirthTime ? (
                    ...
                    <section className="bg-[#a083ff]/5 border border-[#a083ff]/10 rounded-xl p-4 sm:p-6 md:p-8 text-center w-full max-w-full box-border overflow-hidden">
